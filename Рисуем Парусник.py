...
def picture(file_name, width, height, sky_color='#87CEEB', ocean_color='#017B92', boat_color='#874535', sail_color='#FFFFFF', sun_color='#FFCF40'):
    ...
    drawer.polygon(((int(0.25 * width), int(height * 0.85)),
                    (int(0.2 * width), int(height * 0.65)),
                    (int(0.8 * width), int(height * 0.65)),
                    (int(0.75 * width), int(height * 0.85))), boat_color)
    drawer.polygon(((int(0.49 * width), int(height * 0.8)),
                    (int(0.49 * width), int(height * 0.3)),
                    (int(0.51 * width), int(height * 0.3)),
                    (int(0.51 * width), int(height * 0.8))), boat_color)
    drawer.polygon(((int(0.7 * width), int(height * 0.45)),
                    (int(0.51 * width), int(height * 0.3)),
                    (int(0.51 * width), int(height * 0.3)),
...
picture('Парусник.jpg', 1000, 1000)